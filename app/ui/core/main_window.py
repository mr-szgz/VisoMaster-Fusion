...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.RemoteVideoImagesCheckBox = QCheckBox(self.mediaLayout)
        self.RemoteVideoImagesCheckBox.setObjectName(u"RemoteVideoImagesCheckBox")
        self.RemoteVideoImagesCheckBox.setChecked(True)
        self.panelVisibilityCheckBoxLayout.addWidget(self.RemoteVideoImagesCheckBox)
        ...
        self.remote_VideoImages_DockWidget = QDockWidget(MainWindow)
        self.remote_VideoImages_DockWidget.setObjectName(u"remote_VideoImages_DockWidget")
        self.remote_VideoImages_DockWidget.setMinimumSize(QSize(324, 230))
        self.remote_VideoImages_DockWidget.setFeatures(QDockWidget.DockWidgetFeature.DockWidgetFloatable|QDockWidget.DockWidgetFeature.DockWidgetMovable)
        self.dockWidgetContents_RemoteVideoImages = QWidget()
        self.dockWidgetContents_RemoteVideoImages.setObjectName(u"dockWidgetContents_RemoteVideoImages")
        self.gridLayout_RemoteVideoImages = QGridLayout(self.dockWidgetContents_RemoteVideoImages)
        self.gridLayout_RemoteVideoImages.setObjectName(u"gridLayout_RemoteVideoImages")
        self.verticalLayout_RemoteVideoImages = QVBoxLayout()
        self.verticalLayout_RemoteVideoImages.setObjectName(u"verticalLayout_RemoteVideoImages")
        self.remoteVideoImagesContextWidget = QWidget(self.dockWidgetContents_RemoteVideoImages)
        self.remoteVideoImagesContextWidget.setObjectName(u"remoteVideoImagesContextWidget")
        self.horizontalLayout_RemoteVideoImagesContext = QHBoxLayout(self.remoteVideoImagesContextWidget)
        self.horizontalLayout_RemoteVideoImagesContext.setObjectName(u"horizontalLayout_RemoteVideoImagesContext")
        self.labelRemoteVideoImagesContext = QLabel(self.remoteVideoImagesContextWidget)
        self.labelRemoteVideoImagesContext.setObjectName(u"labelRemoteVideoImagesContext")
        self.horizontalLayout_RemoteVideoImagesContext.addWidget(self.labelRemoteVideoImagesContext)
        self.labelRemoteVideoImagesRemoteName = QLabel(self.remoteVideoImagesContextWidget)
        self.labelRemoteVideoImagesRemoteName.setObjectName(u"labelRemoteVideoImagesRemoteName")
        self.labelRemoteVideoImagesRemoteName.setWordWrap(True)
        self.horizontalLayout_RemoteVideoImagesContext.addWidget(self.labelRemoteVideoImagesRemoteName)
        self.horizontalSpacer_RemoteVideoImagesContext = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        self.horizontalLayout_RemoteVideoImagesContext.addItem(self.horizontalSpacer_RemoteVideoImagesContext)
        self.refreshRemoteVideoImagesButton = QPushButton(self.remoteVideoImagesContextWidget)
        self.refreshRemoteVideoImagesButton.setObjectName(u"refreshRemoteVideoImagesButton")
        self.horizontalLayout_RemoteVideoImagesContext.addWidget(self.refreshRemoteVideoImagesButton)
        self.verticalLayout_RemoteVideoImages.addWidget(self.remoteVideoImagesContextWidget)
        self.horizontalLayout_RemoteVideoImagesSearch = QHBoxLayout()
        self.horizontalLayout_RemoteVideoImagesSearch.setObjectName(u"horizontalLayout_RemoteVideoImagesSearch")
        self.remoteVideoImagesSearchBox = QLineEdit(self.dockWidgetContents_RemoteVideoImages)
        self.remoteVideoImagesSearchBox.setObjectName(u"remoteVideoImagesSearchBox")
        self.horizontalLayout_RemoteVideoImagesSearch.addWidget(self.remoteVideoImagesSearchBox)
        self.filterRemoteImagesCheckBox = QCheckBox(self.dockWidgetContents_RemoteVideoImages)
        self.filterRemoteImagesCheckBox.setObjectName(u"filterRemoteImagesCheckBox")
        self.filterRemoteImagesCheckBox.setIcon(icon15)
        self.filterRemoteImagesCheckBox.setChecked(True)
        self.horizontalLayout_RemoteVideoImagesSearch.addWidget(self.filterRemoteImagesCheckBox)
        self.filterRemoteVideosCheckBox = QCheckBox(self.dockWidgetContents_RemoteVideoImages)
        self.filterRemoteVideosCheckBox.setObjectName(u"filterRemoteVideosCheckBox")
        self.filterRemoteVideosCheckBox.setIcon(icon16)
        self.filterRemoteVideosCheckBox.setChecked(True)
        self.horizontalLayout_RemoteVideoImagesSearch.addWidget(self.filterRemoteVideosCheckBox)
        self.verticalLayout_RemoteVideoImages.addLayout(self.horizontalLayout_RemoteVideoImagesSearch)
        self.remoteVideoImagesList = QListWidget(self.dockWidgetContents_RemoteVideoImages)
        self.remoteVideoImagesList.setObjectName(u"remoteVideoImagesList")
        self.remoteVideoImagesList.setAutoScroll(False)
        self.remoteVideoImagesList.setViewMode(QListView.ViewMode.IconMode)
        self.remoteVideoImagesList.setMovement(QListView.Movement.Static)
        self.remoteVideoImagesList.setResizeMode(QListView.ResizeMode.Adjust)
        self.remoteVideoImagesList.setFlow(QListView.Flow.LeftToRight)
        self.verticalLayout_RemoteVideoImages.addWidget(self.remoteVideoImagesList)
        self.gridLayout_RemoteVideoImages.addLayout(self.verticalLayout_RemoteVideoImages, 0, 0, 1, 1)
        self.remote_VideoImages_DockWidget.setWidget(self.dockWidgetContents_RemoteVideoImages)
        MainWindow.addDockWidget(Qt.DockWidgetArea.LeftDockWidgetArea, self.remote_VideoImages_DockWidget)
        ...
        self.remotes_tab = QWidget()
        self.remotes_tab.setObjectName(u"remotes_tab")
        self.verticalLayout_RemotesTab = QVBoxLayout(self.remotes_tab)
        self.verticalLayout_RemotesTab.setObjectName(u"verticalLayout_RemotesTab")
        self.stashApiRemoteHeaderLayout = QHBoxLayout()
        self.stashApiRemoteHeaderLayout.setObjectName(u"stashApiRemoteHeaderLayout")
        self.labelEnableStashApiRemote = QLabel(self.remotes_tab)
        self.labelEnableStashApiRemote.setObjectName(u"labelEnableStashApiRemote")
        self.stashApiRemoteHeaderLayout.addWidget(self.labelEnableStashApiRemote)
        self.horizontalSpacer_StashApiRemote = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        self.stashApiRemoteHeaderLayout.addItem(self.horizontalSpacer_StashApiRemote)
        self.verticalLayout_RemotesTab.addLayout(self.stashApiRemoteHeaderLayout)
        self.stashApiRemoteGroupBox = QGroupBox(self.remotes_tab)
        self.stashApiRemoteGroupBox.setObjectName(u"stashApiRemoteGroupBox")
        self.stashApiRemoteGroupBox.setEnabled(False)
        self.stashApiRemoteGroupBox.setVisible(False)
        self.formLayout_StashApiRemote = QFormLayout(self.stashApiRemoteGroupBox)
        self.formLayout_StashApiRemote.setObjectName(u"formLayout_StashApiRemote")
        self.labelStashApiUrl = QLabel(self.stashApiRemoteGroupBox)
        self.labelStashApiUrl.setObjectName(u"labelStashApiUrl")
        self.formLayout_StashApiRemote.setWidget(0, QFormLayout.LabelRole, self.labelStashApiUrl)
        self.stashApiUrlLineEdit = QLineEdit(self.stashApiRemoteGroupBox)
        self.stashApiUrlLineEdit.setObjectName(u"stashApiUrlLineEdit")
        self.formLayout_StashApiRemote.setWidget(0, QFormLayout.FieldRole, self.stashApiUrlLineEdit)
        self.labelStashApiToken = QLabel(self.stashApiRemoteGroupBox)
        self.labelStashApiToken.setObjectName(u"labelStashApiToken")
        self.formLayout_StashApiRemote.setWidget(1, QFormLayout.LabelRole, self.labelStashApiToken)
        self.stashApiTokenLineEdit = QLineEdit(self.stashApiRemoteGroupBox)
        self.stashApiTokenLineEdit.setObjectName(u"stashApiTokenLineEdit")
        self.formLayout_StashApiRemote.setWidget(1, QFormLayout.FieldRole, self.stashApiTokenLineEdit)
        self.labelStashApiResultsLimit = QLabel(self.stashApiRemoteGroupBox)
        self.labelStashApiResultsLimit.setObjectName(u"labelStashApiResultsLimit")
        self.formLayout_StashApiRemote.setWidget(2, QFormLayout.LabelRole, self.labelStashApiResultsLimit)
        self.stashApiResultsLimitComboBox = QComboBox(self.stashApiRemoteGroupBox)
        self.stashApiResultsLimitComboBox.addItem("")
        self.stashApiResultsLimitComboBox.addItem("")
        self.stashApiResultsLimitComboBox.addItem("")
        self.stashApiResultsLimitComboBox.setObjectName(u"stashApiResultsLimitComboBox")
        self.formLayout_StashApiRemote.setWidget(2, QFormLayout.FieldRole, self.stashApiResultsLimitComboBox)
        self.testStashApiButton = QPushButton(self.stashApiRemoteGroupBox)
        self.testStashApiButton.setObjectName(u"testStashApiButton")
        self.formLayout_StashApiRemote.setWidget(3, QFormLayout.FieldRole, self.testStashApiButton)
        self.labelStashApiTestOutput = QLabel(self.stashApiRemoteGroupBox)
        self.labelStashApiTestOutput.setObjectName(u"labelStashApiTestOutput")
        self.formLayout_StashApiRemote.setWidget(4, QFormLayout.LabelRole, self.labelStashApiTestOutput)
        self.stashApiTestOutputPlainTextEdit = QPlainTextEdit(self.stashApiRemoteGroupBox)
        self.stashApiTestOutputPlainTextEdit.setObjectName(u"stashApiTestOutputPlainTextEdit")
        self.stashApiTestOutputPlainTextEdit.setReadOnly(True)
        self.formLayout_StashApiRemote.setWidget(4, QFormLayout.FieldRole, self.stashApiTestOutputPlainTextEdit)
        self.verticalLayout_RemotesTab.addWidget(self.stashApiRemoteGroupBox)
        self.graphQlRemoteHeaderLayout = QHBoxLayout()
        self.graphQlRemoteHeaderLayout.setObjectName(u"graphQlRemoteHeaderLayout")
        self.labelEnableGraphQlRemote = QLabel(self.remotes_tab)
        self.labelEnableGraphQlRemote.setObjectName(u"labelEnableGraphQlRemote")
        self.graphQlRemoteHeaderLayout.addWidget(self.labelEnableGraphQlRemote)
        self.horizontalSpacer_GraphQlRemote = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        self.graphQlRemoteHeaderLayout.addItem(self.horizontalSpacer_GraphQlRemote)
        self.verticalLayout_RemotesTab.addLayout(self.graphQlRemoteHeaderLayout)
        self.graphQlRemoteGroupBox = QGroupBox(self.remotes_tab)
        self.graphQlRemoteGroupBox.setObjectName(u"graphQlRemoteGroupBox")
        self.graphQlRemoteGroupBox.setEnabled(False)
        self.graphQlRemoteGroupBox.setVisible(False)
        self.formLayout_GraphQlRemote = QFormLayout(self.graphQlRemoteGroupBox)
        self.formLayout_GraphQlRemote.setObjectName(u"formLayout_GraphQlRemote")
        self.labelGraphQlEndpointUrl = QLabel(self.graphQlRemoteGroupBox)
        self.labelGraphQlEndpointUrl.setObjectName(u"labelGraphQlEndpointUrl")
        self.formLayout_GraphQlRemote.setWidget(0, QFormLayout.LabelRole, self.labelGraphQlEndpointUrl)
        self.graphQlEndpointUrlLineEdit = QLineEdit(self.graphQlRemoteGroupBox)
        self.graphQlEndpointUrlLineEdit.setObjectName(u"graphQlEndpointUrlLineEdit")
        self.formLayout_GraphQlRemote.setWidget(0, QFormLayout.FieldRole, self.graphQlEndpointUrlLineEdit)
        self.labelGraphQlAuthHeader = QLabel(self.graphQlRemoteGroupBox)
        self.labelGraphQlAuthHeader.setObjectName(u"labelGraphQlAuthHeader")
        self.formLayout_GraphQlRemote.setWidget(1, QFormLayout.LabelRole, self.labelGraphQlAuthHeader)
        self.graphQlAuthHeaderLineEdit = QLineEdit(self.graphQlRemoteGroupBox)
        self.graphQlAuthHeaderLineEdit.setObjectName(u"graphQlAuthHeaderLineEdit")
        self.formLayout_GraphQlRemote.setWidget(1, QFormLayout.FieldRole, self.graphQlAuthHeaderLineEdit)
        self.labelGraphQlHeadersJson = QLabel(self.graphQlRemoteGroupBox)
        self.labelGraphQlHeadersJson.setObjectName(u"labelGraphQlHeadersJson")
        self.formLayout_GraphQlRemote.setWidget(2, QFormLayout.LabelRole, self.labelGraphQlHeadersJson)
        self.graphQlHeadersPlainTextEdit = QPlainTextEdit(self.graphQlRemoteGroupBox)
        self.graphQlHeadersPlainTextEdit.setObjectName(u"graphQlHeadersPlainTextEdit")
        self.formLayout_GraphQlRemote.setWidget(2, QFormLayout.FieldRole, self.graphQlHeadersPlainTextEdit)
        self.testGraphQlRemoteButton = QPushButton(self.graphQlRemoteGroupBox)
        self.testGraphQlRemoteButton.setObjectName(u"testGraphQlRemoteButton")
        self.formLayout_GraphQlRemote.setWidget(3, QFormLayout.FieldRole, self.testGraphQlRemoteButton)
        self.labelGraphQlTestOutput = QLabel(self.graphQlRemoteGroupBox)
        self.labelGraphQlTestOutput.setObjectName(u"labelGraphQlTestOutput")
        self.formLayout_GraphQlRemote.setWidget(4, QFormLayout.LabelRole, self.labelGraphQlTestOutput)
        self.graphQlTestOutputPlainTextEdit = QPlainTextEdit(self.graphQlRemoteGroupBox)
        self.graphQlTestOutputPlainTextEdit.setObjectName(u"graphQlTestOutputPlainTextEdit")
        self.graphQlTestOutputPlainTextEdit.setReadOnly(True)
        self.formLayout_GraphQlRemote.setWidget(4, QFormLayout.FieldRole, self.graphQlTestOutputPlainTextEdit)
        self.verticalLayout_RemotesTab.addWidget(self.graphQlRemoteGroupBox)
        self.rcloneRemoteHeaderLayout = QHBoxLayout()
        self.rcloneRemoteHeaderLayout.setObjectName(u"rcloneRemoteHeaderLayout")
        self.labelEnableRcloneRemote = QLabel(self.remotes_tab)
        self.labelEnableRcloneRemote.setObjectName(u"labelEnableRcloneRemote")
        self.rcloneRemoteHeaderLayout.addWidget(self.labelEnableRcloneRemote)
        self.horizontalSpacer_RcloneRemote = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        self.rcloneRemoteHeaderLayout.addItem(self.horizontalSpacer_RcloneRemote)
        self.verticalLayout_RemotesTab.addLayout(self.rcloneRemoteHeaderLayout)
        self.rcloneRemoteGroupBox = QGroupBox(self.remotes_tab)
        self.rcloneRemoteGroupBox.setObjectName(u"rcloneRemoteGroupBox")
        self.rcloneRemoteGroupBox.setEnabled(False)
        self.rcloneRemoteGroupBox.setVisible(False)
        self.formLayout_RcloneRemote = QFormLayout(self.rcloneRemoteGroupBox)
        self.formLayout_RcloneRemote.setObjectName(u"formLayout_RcloneRemote")
        self.labelRcloneRemoteName = QLabel(self.rcloneRemoteGroupBox)
        self.labelRcloneRemoteName.setObjectName(u"labelRcloneRemoteName")
        self.formLayout_RcloneRemote.setWidget(0, QFormLayout.LabelRole, self.labelRcloneRemoteName)
        self.rcloneRemoteNameLineEdit = QLineEdit(self.rcloneRemoteGroupBox)
        self.rcloneRemoteNameLineEdit.setObjectName(u"rcloneRemoteNameLineEdit")
        self.formLayout_RcloneRemote.setWidget(0, QFormLayout.FieldRole, self.rcloneRemoteNameLineEdit)
        self.labelRcloneRootPath = QLabel(self.rcloneRemoteGroupBox)
        self.labelRcloneRootPath.setObjectName(u"labelRcloneRootPath")
        self.formLayout_RcloneRemote.setWidget(1, QFormLayout.LabelRole, self.labelRcloneRootPath)
        self.rcloneRootPathLineEdit = QLineEdit(self.rcloneRemoteGroupBox)
        self.rcloneRootPathLineEdit.setObjectName(u"rcloneRootPathLineEdit")
        self.formLayout_RcloneRemote.setWidget(1, QFormLayout.FieldRole, self.rcloneRootPathLineEdit)
        self.labelRcloneCommandPrefix = QLabel(self.rcloneRemoteGroupBox)
        self.labelRcloneCommandPrefix.setObjectName(u"labelRcloneCommandPrefix")
        self.formLayout_RcloneRemote.setWidget(2, QFormLayout.LabelRole, self.labelRcloneCommandPrefix)
        self.rcloneCommandPrefixLineEdit = QLineEdit(self.rcloneRemoteGroupBox)
        self.rcloneCommandPrefixLineEdit.setObjectName(u"rcloneCommandPrefixLineEdit")
        self.formLayout_RcloneRemote.setWidget(2, QFormLayout.FieldRole, self.rcloneCommandPrefixLineEdit)
        self.labelRcloneInterrogation = QLabel(self.rcloneRemoteGroupBox)
        self.labelRcloneInterrogation.setObjectName(u"labelRcloneInterrogation")
        self.formLayout_RcloneRemote.setWidget(3, QFormLayout.LabelRole, self.labelRcloneInterrogation)
        self.enableRcloneInterrogationCheckBox = QCheckBox(self.rcloneRemoteGroupBox)
        self.enableRcloneInterrogationCheckBox.setObjectName(u"enableRcloneInterrogationCheckBox")
        self.formLayout_RcloneRemote.setWidget(3, QFormLayout.FieldRole, self.enableRcloneInterrogationCheckBox)
        self.testRcloneRemoteButton = QPushButton(self.rcloneRemoteGroupBox)
        self.testRcloneRemoteButton.setObjectName(u"testRcloneRemoteButton")
        self.formLayout_RcloneRemote.setWidget(4, QFormLayout.FieldRole, self.testRcloneRemoteButton)
        self.labelRcloneTestOutput = QLabel(self.rcloneRemoteGroupBox)
        self.labelRcloneTestOutput.setObjectName(u"labelRcloneTestOutput")
        self.formLayout_RcloneRemote.setWidget(5, QFormLayout.LabelRole, self.labelRcloneTestOutput)
        self.rcloneTestOutputPlainTextEdit = QPlainTextEdit(self.rcloneRemoteGroupBox)
        self.rcloneTestOutputPlainTextEdit.setObjectName(u"rcloneTestOutputPlainTextEdit")
        self.rcloneTestOutputPlainTextEdit.setReadOnly(True)
        self.formLayout_RcloneRemote.setWidget(5, QFormLayout.FieldRole, self.rcloneTestOutputPlainTextEdit)
        self.verticalLayout_RemotesTab.addWidget(self.rcloneRemoteGroupBox)
        self.verticalSpacer_RemotesTab = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        self.verticalLayout_RemotesTab.addItem(self.verticalSpacer_RemotesTab)
        self.tabWidget.addTab(self.remotes_tab, "")
        ...
        self.stashApiResultsLimitComboBox.setCurrentIndex(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.RemoteVideoImagesCheckBox.setText(QCoreApplication.translate("MainWindow", u"Remote Videos/Images", None))
...
"(For Images only)", None))
        ...
        self.remote_VideoImages_DockWidget.setWindowTitle(QCoreApplication.translate("MainWindow", u"Remote Videos/Images", None))
        self.labelRemoteVideoImagesContext.setText(QCoreApplication.translate("MainWindow", u"Active Remote:", None))
        self.labelRemoteVideoImagesRemoteName.setText(QCoreApplication.translate("MainWindow", u"No remote connected", None))
        self.refreshRemoteVideoImagesButton.setText(QCoreApplication.translate("MainWindow", u"Refresh Results", None))
        self.remoteVideoImagesSearchBox.setText("")
        self.remoteVideoImagesSearchBox.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Search Remote Media", None))
#if QT_CONFIG(tooltip)
        self.filterRemoteImagesCheckBox.setToolTip(QCoreApplication.translate("MainWindow", u"Include Remote Images", None))
#endif // QT_CONFIG(tooltip)
        self.filterRemoteImagesCheckBox.setText("")
#if QT_CONFIG(tooltip)
        self.filterRemoteVideosCheckBox.setToolTip(QCoreApplication.translate("MainWindow", u"Include Remote Videos", None))
#endif // QT_CONFIG(tooltip)
        self.filterRemoteVideosCheckBox.setText("")
        ...
        self.labelEnableStashApiRemote.setText(QCoreApplication.translate("MainWindow", u"Enable Stash API", None))
        self.stashApiRemoteGroupBox.setTitle(QCoreApplication.translate("MainWindow", u"Stash API", None))
        self.labelStashApiUrl.setText(QCoreApplication.translate("MainWindow", u"URL", None))
        self.stashApiUrlLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"https://stash.example/api", None))
        self.labelStashApiToken.setText(QCoreApplication.translate("MainWindow", u"Token", None))
        self.stashApiTokenLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Bearer token or API key", None))
        self.labelStashApiResultsLimit.setText(QCoreApplication.translate("MainWindow", u"Results Limit", None))
        self.stashApiResultsLimitComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"10", None))
        self.stashApiResultsLimitComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"100", None))
        self.stashApiResultsLimitComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"1000", None))
        self.testStashApiButton.setText(QCoreApplication.translate("MainWindow", u"Test", None))
        self.labelStashApiTestOutput.setText(QCoreApplication.translate("MainWindow", u"Test Output", None))
        self.stashApiTestOutputPlainTextEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Run Test to print mock video and image query results here.", None))
        self.labelEnableGraphQlRemote.setText(QCoreApplication.translate("MainWindow", u"Enable GraphQL Endpoint", None))
        self.graphQlRemoteGroupBox.setTitle(QCoreApplication.translate("MainWindow", u"GraphQL Endpoint", None))
        self.labelGraphQlEndpointUrl.setText(QCoreApplication.translate("MainWindow", u"URL", None))
        self.graphQlEndpointUrlLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"https://service.example/graphql", None))
        self.labelGraphQlAuthHeader.setText(QCoreApplication.translate("MainWindow", u"Auth Header", None))
        self.graphQlAuthHeaderLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Authorization: Bearer ...", None))
        self.labelGraphQlHeadersJson.setText(QCoreApplication.translate("MainWindow", u"Headers JSON", None))
        self.graphQlHeadersPlainTextEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"{\"X-API-Key\": \"value\"}", None))
        self.testGraphQlRemoteButton.setText(QCoreApplication.translate("MainWindow", u"Test", None))
        self.labelGraphQlTestOutput.setText(QCoreApplication.translate("MainWindow", u"Test Output", None))
        self.graphQlTestOutputPlainTextEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Run Test to print mock GraphQL media query results here.", None))
        self.labelEnableRcloneRemote.setText(QCoreApplication.translate("MainWindow", u"Enable Rclone Configs", None))
        self.rcloneRemoteGroupBox.setTitle(QCoreApplication.translate("MainWindow", u"Rclone Configs", None))
        self.labelRcloneRemoteName.setText(QCoreApplication.translate("MainWindow", u"Rclone Remote Name", None))
        self.rcloneRemoteNameLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"media-remote", None))
        self.labelRcloneRootPath.setText(QCoreApplication.translate("MainWindow", u"Root Path", None))
        self.rcloneRootPathLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"/library/path", None))
        self.labelRcloneCommandPrefix.setText(QCoreApplication.translate("MainWindow", u"Command Prefix", None))
        self.rcloneCommandPrefixLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"rclone", None))
        self.labelRcloneInterrogation.setText(QCoreApplication.translate("MainWindow", u"Command Access", None))
        self.enableRcloneInterrogationCheckBox.setText(QCoreApplication.translate("MainWindow", u"Allow rclone command interrogation", None))
        self.testRcloneRemoteButton.setText(QCoreApplication.translate("MainWindow", u"Test", None))
        self.labelRcloneTestOutput.setText(QCoreApplication.translate("MainWindow", u"Test Output", None))
        self.rcloneTestOutputPlainTextEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Run Test to print mock rclone interrogation results here.", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.remotes_tab), QCoreApplication.translate("MainWindow", u"Remotes", None))
